...
================================================================================
- This file contains the final button styles for the dark theme.
*/
    ...
    <div className="space-y-4">
      ...
      >
        ...
        >
          ...
          />
          <path
            d="M9 18C11.43 18 13.4673 17.1941 14.9564 15.8195L12.0477 13.5614C11.2418 14.1014 10.2109 14.4205 9 14.4205C6.96273 14.4205 5.26091 13.0123 4.64182 11.1H1.61816V13.4386C3.09818 16.2273 5.82727 18 9 18Z"
            fill="#34A853"
          />
          <path
            d="M4.64182 11.1C4.43455 10.4959 4.32273 9.85455 4.32273 9.18182C4.32273 8.50909 4.43455 7.86773 4.62727 7.26364V4.925H1.61816C0.947727 6.225 0.556364 7.66364 0.556364 9.18182C0.556364 10.7 0.947727 12.1386 1.61816 13.4386L4.64182 11.1Z"
            fill="#FBBC05"
          />
          <path
            d="M9 3.94091C10.3227 3.94091 11.5173 4.42045 12.4782 5.32818L15.0218 2.78455C13.4673 1.28409 11.43 0.363636 9 0.363636C5.82727 0.363636 3.09818 2.13636 1.61816 4.925L4.62727 7.26364C5.26091 5.35227 6.96273 3.94091 9 3.94091Z"
            fill="#EA4335"
          />
        </svg>
