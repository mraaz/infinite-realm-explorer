...
const CallToActionSection = ({ onGetSnapshotClick }: CallToActionSectionProps) => {
  return (
    <div className="bg-white p-8 rounded-lg shadow-xl border border-purple-200 max-w-2xl mx-auto text-center">
      ...
      <Button 
        onClick={onGetSnapshotClick}
        size="lg" 
        className="bg-gradient-to-r from-purple-600 to-blue-500 hover:from-purple-700 hover:to-blue-600 text-white font-semibold text-lg w-full sm:w-auto"
      >
