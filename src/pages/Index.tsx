  ...
  },
  {
    icon: (
      <svg className="w-7 h-7 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v.01M12 6v-1m0-1V4m0 2.01M18 10a6 6 0 11-12 0 6 6 0 0112 0z"></path>
      </svg>
    ),
    title: 'Finances',
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        ...
        <section className="text-center mb-16 md:mb-24">
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-white tracking-tight mb-6">
            Discover Your <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">5-Year Future</span>
          </h2>
        ...
        <section className="flex justify-center">
          <div className="bg-gray-900/50 backdrop-blur-sm p-8 rounded-2xl shadow-2xl ring-1 ring-white/10 text-center max-w-md">
            ...
            <p className="text-gray-400 mb-6">
              Take our quick assessment and unlock your personalized life insights.
            </p>
            
            <button
              onClick={handleGetSnapshotClick}
              className="bg-gradient-cta text-white font-semibold py-3 px-8 rounded-lg hover:opacity-90 transition-opacity duration-200 w-full mb-4"
            >
